    ...
    <div className="px-8 py-8">
      ...
      {tickets.length === 0 ? (
        <div className="rounded-xl border border-zinc-800 bg-zinc-900 py-16 text-center">
          ...
          <p className="text-sm text-zinc-500">Du har ikke sendt noen henvendelser ennå.</p>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-zinc-800 bg-zinc-900">
                ...
                <th className="px-5 py-3 text-left text-xs font-medium text-zinc-500 hidden md:table-cell">Svar</th>
                ...
                return (
                  ...
                  >
                    ...
                    <td className="hidden px-5 py-4 text-xs text-zinc-400 md:table-cell">
                      {ticket._count.replies > 0 ? `${ticket._count.replies} svar` : "Ingen svar ennå"}
                    </td>
