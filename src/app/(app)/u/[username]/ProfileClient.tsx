...
function DropdownMenu({ items, onClose }: { items: MenuItem[]; onClose: () => void }) {
  ...
  return (
    <div
      ref={ref}
      className="absolute right-0 top-10 z-50 min-w-[180px] rounded-xl border border-white/[0.08] bg-[var(--bg-tertiary)] shadow-xl shadow-black/40"
    >
      {items.map((item, i) => (
        <div key={i}>
...
function BottomSheet({
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col justify-end">
      ...
      />
      <div
        className={`relative z-10 rounded-t-2xl border-t border-white/[0.08] bg-[var(--bg-tertiary)] pb-safe transition-transform duration-250 ${
...
function EditProfileModal({ name, bio, avatarUrl, bannerUrl, onClose, onSave }: EditModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-md rounded-2xl border border-white/[0.08] bg-[var(--bg-tertiary)] overflow-hidden">
        {/* Header */}
        ...
        <div className="px-5 pb-5">
          ...
          <div className="flex items-end gap-4 -mt-8 mb-4">
            <div
              className="relative w-16 h-16 rounded-full border-4 border-[var(--bg-tertiary)] overflow-hidden bg-purple-600 flex items-center justify-center text-xl font-bold cursor-pointer group flex-shrink-0"
    ...
    <div className="mx-auto max-w-[680px] px-4 pb-12">
      ...
      <div className="flex items-start justify-between pt-3 mb-4">
        ...
        <div className="relative">
          <div
            className="w-20 h-20 rounded-full border-4 border-[var(--bg-primary)] overflow-hidden -mt-10 bg-purple-600 flex items-center justify-center text-2xl font-bold"
            style={profileFrame ? {
          ...
          {isOnline && (
            <div className="absolute bottom-1 right-1 w-3.5 h-3.5 rounded-full bg-green-400 border-2 border-[var(--bg-primary)]" />
          )}
        </div>
      ...
      {communities.length > 0 && (
        <div className="bg-[var(--bg-secondary)] border border-white/[0.06] rounded-2xl p-4">
