...
export function PushNotificationButton() {
  ...
  return (
    <button
      ...
      className="flex items-center gap-2 rounded-lg border border-[#A855F7]/30 bg-[#A855F7]/20 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-[#A855F7]/30"
    >
