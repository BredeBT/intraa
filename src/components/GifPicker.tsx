...
export function GifPicker({ onSelect, onClose }: Props) {
  ...
  return (
    <div
      ref={containerRef}
      className="absolute bottom-full mb-2 right-0 z-50 w-80 max-w-[calc(100vw-2rem)] bg-[var(--bg-tertiary)] border border-white/10 rounded-2xl shadow-xl overflow-hidden"
    >
